...
When users ask about #help-me-platform (C05FA8B5YPM), you can analyze structured support tickets from Slack Workflow forms.
...
|--------------|------------|---------------|
| #help-me-platform | C05FA8B5YPM | Support tickets (Slack Workflow forms) |
| #platform-all-deliveries | C078S57MS5P | Release announcements |
...
1. *Tom Martin Bergstrøm* - Jan 15, 2026
   ...
   <https://app-eu1.hubspot.com/contacts/YOUR_PORTAL_ID/record/0-5/319272601847|HubSpot #319272601847> | <https://internal.volterra.tech/drivers/952084f9|View in Helix>
`;
