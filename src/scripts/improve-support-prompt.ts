...
- Support phone: 00 00 00 00 (24/7)
...
|------------|----------|------|
| Payment, billing, invoices, subscriptions | @Billing Support | Outstanding payments, pricing questions, invoice issues |
| Charger hardware, offline, unstable | @team-asset-management | Physical charger issues, installations, hardware failures |
| Ampeco, API, integration, connectivity | @Integration Support | Ampeco communication errors, cloud/API issues |
