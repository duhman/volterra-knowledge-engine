...
Parameters:
- p_channel_id: Slack channel ID (default: YOUR_SLACK_CHANNEL_ID = #platform-all-deliveries)
...
Example:
  SELECT * FROM get_reaction_analytics(''YOUR_SLACK_CHANNEL_ID'', ''2025-01-01'', ''2025-12-31'');
';
