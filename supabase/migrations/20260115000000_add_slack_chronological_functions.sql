...
Default channel: YOUR_SLACK_CHANNEL_ID (#help-me-platform). Max limit: 200.
...
Default channel: YOUR_SLACK_CHANNEL_ID (#help-me-platform). Default range: last 7 days. Max limit: 500.
...
BEGIN
  ...
  RAISE NOTICE '  SELECT * FROM get_latest_slack_messages(''YOUR_SLACK_CHANNEL_ID'', 10);';
  RAISE NOTICE '  SELECT * FROM get_slack_messages_by_date(''YOUR_SLACK_CHANNEL_ID'', NOW() - INTERVAL ''24 hours'', NOW(), 50);';
END $$;
