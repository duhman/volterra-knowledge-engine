...
-- Channel: C05FA8B5YPM (#help-me-platform)
--
...
BEGIN
  ...
  WITH extracted AS (
    SELECT
      ...
      'https://volterra.slack.com/archives/' || m.channel_id || '/p' ||
    ...
    WHERE m.channel_id = COALESCE(NULLIF(trim(p_channel_id), ''), 'C05FA8B5YPM')
...
Example: SELECT * FROM volterra_kb.mcp_get_support_tickets(''C05FA8B5YPM'', ''2025-01-01'', NULL, ''Driver'', NULL, 10);';
...
Example: SELECT * FROM volterra_kb.mcp_get_support_analytics(''C05FA8B5YPM'', ''2025-01-01'', NULL);';
...
Example: SELECT * FROM volterra_kb.mcp_get_ticket_thread_insights(''1704067200.123456'', ''C05FA8B5YPM'');';
