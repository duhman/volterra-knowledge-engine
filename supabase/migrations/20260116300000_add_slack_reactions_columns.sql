...
CREATE OR REPLACE FUNCTION volterra_kb.mcp_get_reaction_analytics (
  p_channel_id TEXT DEFAULT 'YOUR_SLACK_CHANNEL_ID', -- platform-all-deliveries
...
Channel IDs: YOUR_SLACK_CHANNEL_ID (platform-all-deliveries), YOUR_SLACK_CHANNEL_ID (help-me-platform).
Example: SELECT * FROM volterra_kb.mcp_get_reaction_analytics(''YOUR_SLACK_CHANNEL_ID'', ''2025-01-01'', ''2025-12-31'');';
