    ...
    inputSchema: {
      ...
      properties: {
        channel_id: {
          type: "string",
          description:
            "Slack channel ID. Default: YOUR_SLACK_CHANNEL_ID (#help-me-platform)",
        },
        limit: {
          type: "integer",
          description:
...
Related tools: For full thread messages use 'fetch_thread_messages', for semantic search use 'kb_search', for network analysis use 'analyze_slack_thread_network'.`,
    inputSchema: {
      ...
      properties: {
        channel_id: {
          type: "string",
          description: "Slack channel ID. Default: YOUR_SLACK_CHANNEL_ID",
        },
        limit: {
          type: "integer",
          description:
...
Channel IDs:
- YOUR_SLACK_CHANNEL_ID: #platform-all-deliveries (release announcements)
- YOUR_SLACK_CHANNEL_ID: #help-me-platform (support discussions)
...
Channel IDs:
- YOUR_SLACK_CHANNEL_ID: #platform-all-deliveries (release announcements) - DEFAULT
...
function slackPermalink(
  ...
  return `https://your-workspace.slack.com/archives/${channelId}/p${tsNoDot}`;
}
...
async function executeSlackLatestMessages(
  ...
  const channelId = params.channel_id ?? "YOUR_SLACK_CHANNEL_ID";
...
async function executeGetReactionAnalytics(
  ...
  const channelId = params.channel_id ?? "YOUR_SLACK_CHANNEL_ID"; // platform-all-deliveries default
